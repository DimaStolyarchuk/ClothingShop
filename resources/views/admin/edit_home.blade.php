                                ...
                                <form class="form-horizontal" role="form" action="{{ route('save_home') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" name="image" class="form-control" id="fname" value="{{$homes->image ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email1">Назва</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="name" class="form-control" id="email1" value="{{$homes->name ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email1">Ціна</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="price" class="form-control" id="email1" value="{{$homes->price ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="email1">Слуг</label>
                                            <div class="col-sm-9">
                                                <input type="text" name="slug" class="form-control" id="email1" value="{{$homes->slug ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
